...
[nostim_m, nostim_vm] = plot4(nostim.sin,sig_vis,base);

[stim_m, stim_vm] = plot4(fix.sin_stim,sig_vis,base);
subplot(2,4,1)
...
[stim_m, stim_vm] = plot4(vis.sin_stim,sig_vis,base);
subplot(2,4,2)
plotdiff(stim_m-nostim_m)
title('vis')
subplot(2,4,2+4)
...
[stim_m, stim_vm] = plot4(mem.sin_stim,sig_vis,base);
subplot(2,4,3)
plotdiff(stim_m-nostim_m)
title('mem')
subplot(2,4,3+4)
...
[stim_m, stim_vm] = plot4(pre.sin_stim,sig_vis,base);
subplot(2,4,4)
plotdiff(stim_m-nostim_m)
title('sac')
subplot(2,4,4+4)
