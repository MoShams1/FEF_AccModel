...
plot4(nostim.vin,nostim.vout,nostim.sin,nostim.sout,sig_vis,1,base,1)
plot4(fix.vin_stim,fix.vout_stim,fix.sin_stim,fix.sout_stim,sig_vis,0,base,1)
subplot(2,4,1)
title('stim fix')

plot4(nostim.vin,nostim.vout,nostim.sin,nostim.sout,sig_vis,1,base,2)
plot4(vis.vin_stim,vis.vout_stim,vis.sin_stim,vis.sout_stim,sig_vis,0,base,2)
subplot(2,4,2)
title('stim vis')

plot4(nostim.vin,nostim.vout,nostim.sin,nostim.sout,sig_vis,1,base,3)
plot4(mem.vin_stim,mem.vout_stim,mem.sin_stim,mem.sout_stim,sig_vis,0,base,3)
subplot(2,4,3)
title('stim mem')

plot4(nostim.vin,nostim.vout,nostim.sin,nostim.sout,sig_vis,1,base,4)
plot4(pre.vin_stim,pre.vout_stim,pre.sin_stim,pre.sout_stim,sig_vis,0,base,4)
subplot(2,4,4)
title('stim sac')
...
function plot4(mvisin,mvisout,msacin,msacout,sig_vis,label,base,column)
c = lines(7);
hold on
ind = ~sig_vis;
