...
text(1,-0.7,'Motor','color','k','rotation',45,'horizontalalignment','right')
text(2,-0.7,'Visuomotor','color','k','rotation',45,'horizontalalignment','right')
...
text(1.5,.8,aster,'horizontalalignment','center')
aster = calaster(signrank(r_mot,0));
text(1,.7,aster,'horizontalalignment','center')
aster = calaster(signrank(r_vis,0));
text(2,.7,aster,'horizontalalignment','center')
line([1 2],[.75 .75],'color','k')
line([1 1],[.74 .75],'color','k')
line([2 2],[.74 .75],'color','k')
