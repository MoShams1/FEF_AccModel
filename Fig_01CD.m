...
in = 106;
[mvis_in, mvis_out, msac_in, msac_out] = extract(data{in});
...
function [vis_in, vis_out, sac_in, sac_out] = extract(data)

kstd = 20; % smoothing kernel's standard deviation
...
title(['Sample ',class,' neuron (ntrials=',num2str(size(mvisin,1)),')'])
